          ...
          {canAssignRole && (
            <div style={{
              ...
              <div style={{
                ...
                <span style={{ fontSize: '0.85rem', color: '#3b4045', fontWeight: 600 }}>
              ...
              {roleMessage && (
                <p style={{ margin: '0.5rem 0 0', fontSize: '0.8rem', color: '#188038' }}>
                  {roleMessage}
                </p>
              )}
              {roleError && (
                <p style={{ margin: '0.5rem 0 0', fontSize: '0.8rem', color: '#d93025' }}>
                  {roleError}
                </p>
              )}
            </div>
